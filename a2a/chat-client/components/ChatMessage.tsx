    ...
    <div className="w-full my-1 justify-start">
      <div className="flex items-center gap-2 mb-1">
        <div className="flex-shrink-0">
          <img alt="logo" src={appConfig.logoUrl} className="w-6 h-8" />
        </div>
    ...
    return (
      <div className="flex w-full my-1 items-start gap-2 justify-end">
        ...
        <div className="flex-shrink-0 pt-1">
          <UserLogo className="w-6 h-8 text-gray-400" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full my-1 justify-start">
      ...
      <div className="ml-10 flex-grow min-w-0">
        ...
        {message.customerAddresses && message.customerAddresses.length > 0 && onSelectAddress && (
          <AddressSelector
            addresses={message.customerAddresses}
